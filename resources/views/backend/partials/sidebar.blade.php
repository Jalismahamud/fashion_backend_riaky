    ...
    <div class="app-sidebar" style="overflow: scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu mt-2">
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.category.index') ? 'has-link' : '' }}"
                        href="{{ route('admin.category.index') }}">
                        <span><i class="side-menu__icon fa-solid fa-list"></i></span>
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('show.constact.us') ? 'has-link' : '' }}"
                        href="{{ route('show.constact.us') }}">
                        <svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon"
                            enable-background="new 0 0 24 24" viewBox="0 0 24 24">
                            <path
                                d="M19.9794922,7.9521484l-6-5.2666016c-1.1339111-0.9902344-2.8250732-0.9902344-3.9589844,0l-6,5.2666016C3.3717041,8.5219116,2.9998169,9.3435669,3,10.2069702V19c0.0018311,1.6561279,1.3438721,2.9981689,3,3h2.5h7c0.0001831,0,0.0003662,0,0.0006104,0H18c1.6561279-0.0018311,2.9981689-1.3438721,3-3v-8.7930298C21.0001831,9.3435669,20.6282959,8.5219116,19.9794922,7.9521484z M15,21H9v-6c0.0014038-1.1040039,0.8959961-1.9985962,2-2h2c1.1040039,0.0014038,1.9985962,0.8959961,2,2V21z M20,19c-0.0014038,1.1040039-0.8959961,1.9985962-2,2h-2v-6c-0.0018311-1.6561279-1.3438721-2.9981689-3-3h-2c-1.6561279,0.0018311-2.9981689,1.3438721-3,3v6H6c-1.1040039-0.0014038-1.9985962-0.8959961-2-2v-8.7930298C3.9997559,9.6313477,4.2478027,9.0836182,4.6806641,8.7041016l6-5.2666016C11.0455933,3.1174927,11.5146484,2.9414673,12,2.9423828c0.4853516-0.0009155,0.9544067,0.1751099,1.3193359,0.4951172l6,5.2665405C19.7521973,9.0835571,20.0002441,9.6313477,20,10.2069702V19z" />
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.quiz.*') ? 'has-link' : '' }}"
                        href="{{ route('admin.quiz.index') }}">
                        <span><i class="side-menu__icon fa fa-question-circle"></i></span>
                        <span class="side-menu__label">Quiz Questions</span>
                    </a>
                </li>

                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.plan.*') ? 'has-link active' : '' }}"
                ...
                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.review.*') ? 'has-link active' : '' }}"
                        href="{{ route('admin.review.index') }}">
                        <i class="fa-solid fa-quote-right" style="font-size: 20px; margin-right: 7px;"></i>
                        <span class="side-menu__label">Review List</span>
                    </a>
                </li>

                <li class="slide">
                    <a class="side-menu__item {{ request()->routeIs('admin.website.*') ? 'has-link active' : '' }}"
                        href="{{ route('admin.website.index') }}">
                        <i class="fa-solid fa-link" style="font-size: 20px; margin-right: 7px;"></i>
                        <span class="side-menu__label">Website Name List</span>
                    </a>
                </li>
                ...
                {{-- <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('cms.page.auth.section.bg.index') }}" class="slide-item">Auth Page</a>
                        </li>
                    </ul>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('social.link.index') }}" class="slide-item">Social Profile</a>
                        </li>
                    </ul>
                </li>
            </ul>
