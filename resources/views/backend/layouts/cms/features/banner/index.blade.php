{{-- filepath: c:\laragon\www\anand_kasi_backend\resources\views\backend\layouts\cms\features\index.blade.php --}}
@extends('backend.app', ['title' => 'CMS : Features'])
        ...
        <div class="side-app">
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">CMS : Features</h1>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 mx-auto">
                        <div class="card shadow-sm rounded-4">
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.cms.features.banner.content') }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="summernote form-control @error('description') is-invalid @enderror"
                                            ...
                                            id="description"
                                            rows="4"
                                            placeholder="Enter features description">{{ old('description', $section->description ?? '') }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
