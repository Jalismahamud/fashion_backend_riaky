@extends('backend.app', ['title' => 'CMS : Home Explore'])
        ...
        <div class="side-app">
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <div>
                        <h1 class="page-title">CMS : Home Explore</h1>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 mx-auto">
                        <div class="card shadow-sm rounded-4">
                            <div class="card-body">
                                <form method="POST" action="{{ route('admin.cms.home.explore.content') }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="summernote form-control @error('description') is-invalid @enderror"
                                            ...
                                            id="description"
                                            rows="4"
                                            placeholder="Enter explore description">{{ old('description', $section->description ?? '') }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback d-block" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
